...
4. **Note on Stability**: We are continuously working on adding stricter Tableau rules and logic constraints to ensure the generated reports do not break when opened in Tableau.
